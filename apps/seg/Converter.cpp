...
//                Helper::SplitString(attrString,labelStr,attributesStr,";");
...
//
//            // these are required
//            categoryCode = Helper::StringToCodeSequenceMacro(label2attributes[label].lookupAttribute("SegmentedPropertyCategory"));
//            typeCode = Helper::StringToCodeSequenceMacro(label2attributes[label].lookupAttribute("SegmentedPropertyType"));
//
...
//                Helper::TokenizeString(rgbStr,rgbStrVector,",");
